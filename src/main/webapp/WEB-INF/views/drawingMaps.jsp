...
<div id= "result"></div>
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=d9c351ec80a7e5791edf33b41ef8252d&libraries=drawing"></script>
<script>
...
function getDataFromDrawingMap() {
	...
	window.alert(data[kakao.maps.drawing.OverlayType.POLYGON]);
}
